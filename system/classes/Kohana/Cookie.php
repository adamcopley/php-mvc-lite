...
class Kohana_Cookie {
	...
	public static function get($key, $default = NULL)
	{
		...
		if (isset($cookie[$split]) AND $cookie[$split] === '~')
		{
			...
			if (PML::slow_equals(Cookie::salt($key, $value), $hash))
			{
	...
	public static function salt($name, $value)
	{
		...
		if ( ! Cookie::$salt)
		{
			throw new Exception('A valid cookie salt is required. Please set cookie_salt in your config. For more information check the documentation');
		}
